...
public class BookAdapterssssssmoviesfragment extends RecyclerView.Adapter<BookAdapterssssssmoviesfragment.RecyclerViewHolder> {
    ...
    public BookAdapterssssssmoviesfragment(MoviesFragment context, int drawable) {
    ...
    @Override
    public BookAdapterssssssmoviesfragment.RecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new RecyclerViewHolder(LayoutInflater.from(parent.getContext())
                .inflate(drawable, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull final BookAdapterssssssmoviesfragment.RecyclerViewHolder holder, int position) {
    ...
    public void setOnItemClickListener(ClickListener clickListener) {
        BookAdapterssssssmoviesfragment.clickListener = clickListener;
    }
