...
import com.example.designer2.moviesapp.adapters.BookAdaptersssssstopfragment;
...
public class TopsongsFragment extends Fragment {
    ...
    BookAdaptersssssstopfragment bookAdapterssssss;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.top, container, false);
        recyclerViewsss = (RecyclerView) v.findViewById(R.id.recyclerviewfragmenttops);
        bookAdapterssssss = new BookAdaptersssssstopfragment(this, R.layout.gridrv_row_items2);
        ...
        bookAdapterssssss.setOnItemClickListener(new BookAdaptersssssstopfragment.ClickListener() {
            @Override
    ...
    private void observeViewModel(VideoViewModel bookViewModel) {
        ...
        bookViewModel.getBookListLiveData().observe(this,
                new Observer<VideosModel>() {
                    @Override
