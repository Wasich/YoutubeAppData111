...
public class BookAdaptersssssstopfragment extends RecyclerView.Adapter<BookAdaptersssssstopfragment.RecyclerViewHolder> {
    ...
    public BookAdaptersssssstopfragment(TopsongsFragment context, int drawable) {
    ...
    @Override
    public BookAdaptersssssstopfragment.RecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new RecyclerViewHolder(LayoutInflater.from(parent.getContext())
                .inflate(drawable, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull final BookAdaptersssssstopfragment.RecyclerViewHolder holder, int position) {
    ...
    public void setOnItemClickListener(ClickListener clickListener) {
        BookAdaptersssssstopfragment.clickListener = clickListener;
    }
